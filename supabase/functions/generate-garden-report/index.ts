...
// Define companion planting data directly in the edge function since we can't import from src
...
const companionPlantingData: Record<string, CompanionPlantData> = {
  "tomato": {
    plant: "tomato",
...
const findCompanionData = (plantName: string): CompanionPlantData | null => {
